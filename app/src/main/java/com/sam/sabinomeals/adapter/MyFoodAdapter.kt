...
import com.sam.sabinomeals.eventBus.FoodClick
...
class MyFoodAdapter(internal var context: Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):MyViewHolder {
        return MyViewHolder(LayoutInflater.from(context).inflate(R.layout.layout_food_list_item, parent, false))
    }
    ...
    override fun onBindViewHolder(holder:MyViewHolder, position: Int) {
        Glide.with(context).load(foodModels[position].image).into(holder.img_food_image!!);
        holder.txt_food_name!!.text = foodModels[position].name!!
        holder.txt_food_price!!.text = foodModels[position].price!!.toString()

        //EventBus
        holder.setListener(object :
           IRecyclerClickListener {
            override fun onItemClickListener(view: View, position: Int) {
                Common.FOOD_SELECTED = foodModels[position]
                Common.FOOD_SELECTED!!.key = position.toString()
                EventBus.getDefault().postSticky(FoodClick(true, foodModels[position]))
            }
        ...
        holder.img_img_quick_cart!!.setOnClickListener {
            ...
            cartItem.foodId = foodModels[position].id
            cartItem.foodName = foodModels[position].name
            cartItem.foodImage = foodModels[position].image
                        ...
                        if (cartItemFromDB.equals(cartItem)) {
                            ...
                            compositeDisposable.add(cartDataSource.insertOrReplaceAll(cartItem)
                                ...
                                .subscribe({
                                    ...
                                    Toast.makeText(
                                        context,
                                        "Basket Addition Error" + t!!.message,
                                        Toast.LENGTH_SHORT
                                    ).show()
                                })
                            )
