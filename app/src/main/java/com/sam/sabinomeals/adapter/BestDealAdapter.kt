...
import com.sam.sabinomeals.eventBus.BestDealItemClick
import com.sam.sabinomeals.models.BestDealModel
import net.sam.sabinomeals.R
import org.greenrobot.eventbus.EventBus

class BestDealAdapter(context: Context,
                      itemList: List<BestDealModel>,
                      isInfinitie:Boolean): LoopingPagerAdapter<BestDealModel>(context,itemList,isInfinitie) {
