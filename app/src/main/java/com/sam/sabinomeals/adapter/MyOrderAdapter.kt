...
class MyOrderAdapter(internal var context: Context,
                     private var orderModels:MutableList<OrderModel>
):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
       return MyViewHolder(
           LayoutInflater.from(context).inflate(R.layout.layou_order_item, parent, false)
       )
    }
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.txt_order_number.setText(StringBuilder("Order Number: ").append(orderModels.get(position).key));
        holder.txt_order_comment.setText( StringBuilder("Additional Info: ").append(orderModels.get(position).comment));
