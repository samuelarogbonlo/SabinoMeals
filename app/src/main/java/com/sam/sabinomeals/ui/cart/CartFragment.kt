...
import com.sam.sabinomeals.Callback.ILoadTimeFromFireBaseListener
import com.sam.sabinomeals.Callback.MyButtonCallBack
import com.sam.sabinomeals.Remote.ICloudFunctions
import com.sam.sabinomeals.Remote.IFCMService
import com.sam.sabinomeals.Remote.RetrofitCloudClient
import com.sam.sabinomeals.Remote.RetrofitFCMClient
import com.sam.sabinomeals.adapter.MyCartAdapter
import com.sam.sabinomeals.commons.Common
import com.sam.sabinomeals.commons.MySwiperHelper
...
import com.sam.sabinomeals.eventBus.CounterCartEvent
import com.sam.sabinomeals.eventBus.HideFabCart
...
class CartFragment : Fragment(), ILoadTimeFromFireBaseListener {
    override fun onLoadTimeSuccess(orderModel: OrderModel, estimateTimeInMs: Long) {
    ...
    override fun onCreateView(
        ...
        fcmServices = RetrofitFCMClient.getInstance().create(
    ...
    private fun initView(root: View?) {
        setHasOptionsMenu(true)     //To make menu inflate
        ...
        //Delete plate
        val swipe = object : MySwiperHelper(requireContext(), recycler_cart!!, 200) {
            override fun instantiateMyButton(
                viewHolder: RecyclerView.ViewHolder,
                buffer: MutableList<MyButton>
            ) {
                buffer.add(
                    MyButton(context!!, "Remove", 30, 0, Color.parseColor("#E13F3F"),
                ...
                cartDataSource!!.sumPriceInCart(Common.currentUser!!.uid!!)
                    ...
                    .subscribe(object : SingleObserver<Double> {
                        override fun onSuccess(totalPrice: Double) {
                            ...
                            orderModel.finalPayement = totalPrice
                            orderModel.isCod = true
                            orderModel.transactionId = "Cash on delivery"
    ...
    private fun syncLocationTimeWithCGlobalTime(orderModel: OrderModel) {
        ...
        offsetDatabaseReference.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                val estimatedTimedServer = System.currentTimeMillis() + offset!!
                val sdf = SimpleDateFormat("MMM dd,yyyy HH:mm")
                val resultDate = Date(estimatedTimedServer)
                listener!!.onLoadTimeSuccess(
                    orderModel = orderModel,
                    estimateTimeInMs = estimatedTimedServer
                )
            }
                ...
                cartDataSource!!.cleanCart(Common.currentUser!!.uid!!)
                    ...
                    .subscribe(object : SingleObserver<Int> {
                        override fun onSuccess(t: Int) {
                            ...
                            notiData.put(Common.NOTI_CONTENT!!,"New Order Content"+ Common.currentUser!!.phone)
